...
Route::middleware('auth')->group(function () {
    ...
    // Categories
    Route::get('/categories', [CategorieController::class, 'index'])->name('app.categories.index');
    Route::get('/categories/{category}', [CategorieController::class, 'show'])->name('app.categories.show');
